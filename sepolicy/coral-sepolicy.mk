...
# misc_writer
BOARD_VENDOR_SEPOLICY_DIRS += device/google/coral/sepolicy/vendor/misc_writer

# thermal
BOARD_VENDOR_SEPOLICY_DIRS += device/google/coral/sepolicy/vendor/thermal

# Lineage-specific
BOARD_VENDOR_SEPOLICY_DIRS += device/google/coral/sepolicy/lineage/dynamic
BOARD_VENDOR_SEPOLICY_DIRS += device/google/coral/sepolicy/lineage/vendor
